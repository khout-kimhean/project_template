...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../Admin Dashboard/styles/add_task_team.css">
        ...
        <main>
            <div class="container2">
                <div class="back_button">
                    <a href="../templates/todo_management.php" class="back-button">
                        <i class="fa fa-chevron-circle-left" style="font-size: 25px">Back</i>
                    </a>
                </div>
                <h2>Create Task</h2>
                <div class="create_task">
                    <input type="text" name="name" required placeholder="create Task for user here">
                    <form action="../templates/todo_management.php">
                        <input type="submit" name="submit" value="Create" class="form-btn">
                    </form>
                </div>
                <h2>Add Task to Team</h2>
                <div class="task">
                    <h2>Process</h2>
                    <h2>Done</h2>
                    <h2>Progress</h2>
