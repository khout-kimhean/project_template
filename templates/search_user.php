...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../Admin Dashboard/styles/search_user.css">
                    ...
                    <div class="col-md-8 offset-md-2">
                        <div class="card">
                            <div class="card-header" class="back-button">
                                ...
                                <span><a href="../templates/user_management.php" class="back-button"><i
                                            ...
                                            if (!empty($searchResults)) {
                                                ...
                                                foreach ($searchResults as $row) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a
                                                                href="edit_user.php?id=<?php echo $row['permission']; ?>">Add Permission</a>
                                                        </td>
                                                        </td>
                                                        <td><a
                                                                href="search_user.php?id=<?php echo $row['name']; ?>">Delete</a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                }
