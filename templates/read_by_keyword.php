...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../Admin Dashboard/styles/read_by_keyword.css">
    ...
    <div class="container">
        ...
        <main>
            <div class="container2">
                ...
                <h2>Text Reader Show All line We Search</h2>
                    ...
                    function processFile() {
                        ...
                        if (file) {
                            ...
                            reader.onload = function (e) {
                                ...
                                // Extract lines containing the searchKeyNumber
                                const lines = fileContent.split(/\r?\n/);
                                const matchingLines = lines.filter(line => line.includes(searchKeyNumber));

                                // Display the result
                                if (matchingLines.length > 0) {
                                    outputDiv.innerText = "Lines containing the search key number '" + searchKeyNumber + "':\n" + matchingLines.join('\n');
                                } else {
                                    outputDiv.innerText = "No lines containing the search key number '" + searchKeyNumber + "' found.";
                                }
                            };
