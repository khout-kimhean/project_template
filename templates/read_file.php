...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../Admin Dashboard/styles/read_file.css">
    ...
    <div class="container">
        ...
        <main>
            <Div class="container2">
                <h1 class="h1">Read File To text</h1>
                <!-- Analyses -->
                <div class="analyse">
                    <div class="sales">
                        <div class="status">
                            <div class="info">
                                <a href="../templates/read_by_keyword.php">
                                    <!-- <h3>Read Text</h3> -->
                                    <h1>Read Key Number</h1>
                                </a>
                            </div>
                            <div>
                                <a href="../templates/read_by_keyword.php">
                    ...
                    <div class="visits">
                        <div class="status">
                            <div class="info">
                                <a href="../templates/read_error_trx.php">
                                    <h1>Read Line issue in text</h1>
                                </a>
                            </div>
                            <div>
                                <a href="../templates/read_error_trx.php">
                    ...
                    <div class="sales">
                        <div class="status">
                            <div class="info">
                                <a href="../templates/extract_img.php">
                                    <h1>Read Img to Text</h1>
                                </a>
                            </div>
                            <div>
                                <a href="../templates/.php">
