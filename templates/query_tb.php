...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // Merge data from Table1 (view_all) into tb_chat
    $sqlMergeTable1 = "INSERT IGNORE INTO tb_chat (question_bot, answer_bot, error)
    SELECT pspn_code, sulution, error
    FROM view_all";
    ...
    // Merge data from Table2 (input_file) into tb_chat
    $sqlMergeTable2 = "INSERT IGNORE INTO tb_chat (question_bot, answer_bot , error)
    SELECT short_description, description, title
    FROM chat_data";
    ...
    <div class="container">
        ...
        <aside>
            ...
            <div class="sidebar">
                ...
                <a href="../templates/query_tb.php" class="active">
                    <span class="material-icons-sharp">
        ...
        <main>
            <div class="button_sub">
                ...
                <form action="query_tb.php" method="post">
